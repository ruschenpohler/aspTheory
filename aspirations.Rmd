...
### THEORY
I. Aspirations Failures (Dalton, Ghosal, Mani)  
II. Aspiration Frustration (Genicot, Ray)  
...
The agent derives utility from two additively separable components: (i) final wealth $y_{c}$ and (ii) its relative level with respect to her aspirations $y_{c} - a_{c}$.
...
Bandura's **self-efficacy and locus of control**
### 2. What is the difference between hope and aspirations?
### 3. How does agency fit into aspirations theory?
### 4. How to measure aspirations?
### 5. What are potentially fruitful areas of study?
### 6. Any new ideas?
