...
local Outcomes	asp12_shop_z asp12_sales asp12_size asp12_employee asp12_customer ///
				...
				asp_educ_son asp_educ_son_ma asp_educ_dtr asp_educ_dtr_ma asp_educ_kids asp_educ_kids_ma ///
...
foreach T in	book_only book_mov book_ast book_mov_ast {
	...
	foreach y in 	asp12_shop_z asp12_sales asp12_size asp12_employee asp12_customer ///
					asp_shop_z asp_size asp_employee asp_customer ///
					asp_occup_kids ///
					asp_educ_son asp_educ_son_ma ///											// aspgap_educ_son
					asp_educ_dtr asp_educ_dtr_ma ///											// aspgap_educ_dtr
					asp_educ_kids asp_educ_kids_ma {											// aspgap_educ_kids
	
					gen `T'_`y'_AM				= `T' * W1_`y'_AM
					//gen `T'_`y'_BM			= `T' * (1 - W1_`y'_AM)
					
					local label : var label `T'
					label var `T'_`y'_AM		"Abv MD Baseline Asps X `label'"
	}
	
				gen `T'_size_AM					= `T' * W1_size_AM
				//gen `T'_size_BM				= `T' * W1_size_BM
				label var `T'_size_AM			"Abv MD Business Size X `label'"
				//label var `T'_size_BM			"Blw MD Business Size X `label'"
				
				gen `T'_male					= `T' * W1_male
				//gen	`T'_female					= `T' * (1 - W1_male)
				label var `T'_male				"Male X `label'"
				//label var `T'_female			"Female X `label'"
}
