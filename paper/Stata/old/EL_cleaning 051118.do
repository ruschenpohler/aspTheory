...
replace asp_occup_daughter_oth = 7 if inlist(f4_10_5c_ot,"KARYAWAN PABRIK","PEGAWAI PABRIK","PEKERJA PABRIK SEPATU","KARYAWAN INDUSTRI")
replace asp_occup_daughter_oth = 8 if f4_10_5c_ot=="MACHINIST"
replace asp_occup_daughter_oth = 13 if inlist(f4_10_5c_ot,"KARYAWAN DI KANTOR","ADMINISTRASI","ADMINISTRASI STAFF","KANTORAN","STAF KANTOR SWASTA","STAFF KANTORAN","KARYAWAN KANTORAN","KARYAWAN SWASTA","KARYAWQAN SWASTA TAPI GA TAU PROFESINYA")
replace asp_occup_daughter_oth = 14 if inlist(f4_10_5c_ot,"MANAGER","SUPERVISOR","MANAJER PERUHASAAN")
replace asp_occup_daughter_oth = 19 if f4_10_5c_ot=="PELAYARAN ATAU ANGKATAN LAUT"
replace asp_occup_daughter_oth = 20 if f4_10_5c_ot=="WALIKOTA"
replace asp_occup_daughter_oth = 26 if f4_10_5c_ot=="ARSITEK"
replace asp_occup_daughter_oth = 29 if inlist(f4_10_5c_ot,"PRESIDEN","MENTERI KEUANGAN")

gen asp_occup_daughter_nongovt = 1 if inlist(f4_10_5c_ot,"MASINIS","KONTRAKTOR","PABRIK","KAPTEN PELAYARAN","USTADZ","USTAD","USTADZAH","IHUTAN(AHLI KEAGAMAAN) PAUS DI KRISTEN","APOTEKER") | ///
...
replace asp_educ_daughter = 25 if asp_educ_daughter==26
