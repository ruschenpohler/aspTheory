...
* Run latest datamanagement_smallretailers do-file beforehand
********************************************************************************
...
use smallretail_data.dta, clear
...
* regress yvar xvarlist, vce(robust) // level(#)
* reg wage c.age##i.male c.age#c.age c.age#c.age#i.male, vce(robust) // Regress wage on age, male,ageØ­ale, age2, and age2Ø­ale with age being continuous (c) and male a binary (i)
