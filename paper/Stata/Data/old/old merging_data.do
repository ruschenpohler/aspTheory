...
do "Data\Baseline Data\BL_cleaning.do"
do "Data\Endline Data\EL_cleaning.do"
do "Data\Endline 2 Data\EL2_cleaning.do"
...
*** Read in data from wave 3
use	"Data\Endline Data\W3_clean_data", clear

*ATTRITION VARIABLES
replace W3_finished=0 if W3_finished==.
drop W3_refused W3_closed

* Merge with data for attritors
merge 1:1 shop_ID using  "Data\Endline Data\attritors"
tab _m
drop _m

*** Read in data from wave 1
merge 1:1 shop_ID using "Data\Baseline Data\W1_clean_data"
tab _m
drop _m

*** Merge with distance data
merge 1:1 shop_ID using "Data\Intervention Data\mov_distance", keepusing(mov_distance)
tab _m
drop _m

*** Merge with data from wave 2
merge 1:1 shop_ID using "Data\Intervention Data\W2_clean_data"
tab _m
drop _m
...
label var BCT "Received Handbook & Counseling"

gen BMCT = ((W2_ast_2_ast==1) | (W2_ast_1_ast==1)) & (W2_mov_attend==1) & (BMC==1)
label var BMCT "Received All Three"
...
*** Read in data from wave 4
use	"Data\Endline 2 Data\W4_clean_data", clear
...
*** Merge with distance data
merge 1:1 shop_ID using "Data\Intervention Data\mov_distance.dta", keepusing(mov_distance)
tab _m
drop _m
...
***** Merging Wave 3 and Wave 4

use	"Data\Endline Data\W3_clean_data", clear

*** Merge with data from wave 3
append using "Data\Endline 2 Data\W4_clean_data", gen(Wave3)


order shop_ID Wave3 control anytreat B BT BM BMT BC BCT BMC BMCT




* Dropping 5 observations from Ps Baru
