...
***** Load wave 1 data
use	"Data\Baseline Data\W1_clean_data", clear
...
merge 1:1 shop_ID using "Data\Endline Data\W3_clean_data"
tab _m
drop _m
...
*** Merge with data from wave 4
merge 1:1 shop_ID using "Data\Endline 2 Data\W4_clean_data"



***** GPS **********************************************************************

label var mov_distance		"Distance to screening location"
...
label var BT "Received Book"

gen BMT = (W2_mov_attend==1) & (BM==1)
label var BMT "Received Book & Movie"

gen BCT = ((W2_ast_2_ast==1) | (W2_ast_1_ast==1)) & (BC==1)
*replace BCT = 0.5 if W2_ast_1_ast==1 & BCT==0 & BC==1
label var BCT "Received Book & Counsel (At Least 1 Session)"

gen BCT2 = (W2_ast_2_ast==1) & (W2_ast_1_ast==1) & (BC==1)
*replace BCT = 0.5 if W2_ast_1_ast==1 & BCT==0 & BC==1
label var BCT "Received Book & Counsel (Both Session)"
...
* Order vars
sort shop_ID control anytreat B BT BM BMT BC BCT BMC BMCT
