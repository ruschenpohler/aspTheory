...
* Detect missing values in aspiration vars --> 0 obs
...
*** Aspiration gaps
gen asp_gap3_ideal_space 	= (asp_ideal_space - space_cont)/asp_ideal_space
gen asp_gap3_ideal_employ 	= (asp_ideal_employ - labour_total)/asp_ideal_employ
gen asp_gap3_ideal_custom 	= (asp_ideal_custom - custom_total)/asp_ideal_custom

* Dummies for neg/zero/pos aspirations gap
foreach x of varlist asp_gap3_ideal_* {
	gen `x'_neg = 1 if `x'<0
...
replace 	asp_ideal_yrs =. if asp_ideal_yrs==9996 | asp_ideal_yrs==9998
...
replace 	asp_ideal_yrs_dk = 0 if f4_10_01e<9996
...
* Ideal shop aspiration gaps

egen 	asp_gap3_ideal_space_mu 	= mean(asp_gap3_ideal_space)
egen 	asp_gap3_ideal_space_sd 	= sd(asp_gap3_ideal_space)
gen 	asp_gap3_ideal_space_z 	= (asp_gap3_ideal_space - asp_gap3_ideal_space_mu)/asp_gap3_ideal_space_sd

egen 	asp_gap3_ideal_employ_mu 	= mean(asp_gap3_ideal_employ)
egen 	asp_gap3_ideal_employ_sd 	= sd(asp_gap3_ideal_employ)
gen 	asp_gap3_ideal_employ_z 	= (asp_gap3_ideal_employ - asp_gap3_ideal_employ_mu)/asp_gap3_ideal_employ_sd

egen 	asp_gap3_ideal_custom_mu 	= mean(asp_gap3_ideal_custom)
egen 	asp_gap3_ideal_custom_sd 	= sd(asp_gap3_ideal_custom)
gen 	asp_gap3_ideal_custom_z 	= (asp_gap3_ideal_custom - asp_gap3_ideal_custom_mu)/asp_gap3_ideal_custom_sd

gen 	asp_gap3_ideal_shop 		= (asp_gap3_ideal_space_z + asp_gap3_ideal_employ_z + asp_gap3_ideal_custom_z)/3
...
replace 	asp_12mth_custom =. if f4_10_02c==9998
label val 	asp_12mth_custom f4_10_02c


*** Aspiration gaps
gen asp_gap3_12mth_space 	= (asp_12mth_space - space_cont)/asp_12mth_space
gen asp_gap3_12mth_employ 	= (asp_12mth_employ - labour_total)/asp_12mth_employ
gen asp_gap3_12mth_custom 	= (asp_12mth_custom - custom_total)/asp_12mth_custom

* Dummies for neg/zero/pos aspiration gaps
foreach x of varlist asp_gap3_12mth_* {
	gen `x'_neg = 1 if `x'<0
	replace `x'_neg = 0 if `x'_neg ==.
	gen `x'_0 = 1 if `x'==0
	replace `x'_0 = 0 if `x'_0 ==.
...
* Dummy for neg 12mth AND ideal aspirations
gen 	asp_gap3_employ_neg_rebound = 1 if asp_gap3_12mth_employ<0 & asp_ideal_employ>asp_12mth_employ
replace asp_gap3_employ_neg_rebound = 0 if asp_gap3_employ_neg_rebound==.

gen 	asp_gap3_employ_neg_perm = 1 if asp_gap3_12mth_employ<0 & asp_ideal_employ<=asp_12mth_employ
replace asp_gap3_employ_neg_perm = 0 if asp_gap3_employ_neg_perm==.
...
* 12mth aspiration gaps

egen 	asp_gap3_12mth_space_mu 	= mean(asp_gap3_12mth_space)
egen 	asp_gap3_12mth_space_sd 	= sd(asp_gap3_12mth_space)
gen 	asp_gap3_12mth_space_z 	= (asp_gap3_12mth_space - asp_gap3_12mth_space_mu)/asp_gap3_12mth_space_sd

egen 	asp_gap3_12mth_employ_mu 	= mean(asp_gap3_12mth_employ)
egen 	asp_gap3_12mth_employ_sd 	= sd(asp_gap3_12mth_employ)
gen 	asp_gap3_12mth_employ_z 	= (asp_gap3_12mth_employ - asp_gap3_12mth_employ_mu)/asp_gap3_12mth_employ_sd

egen 	asp_gap3_12mth_custom_mu 	= mean(asp_gap3_12mth_custom)
egen 	asp_gap3_12mth_custom_sd 	= sd(asp_gap3_12mth_custom)
gen 	asp_gap3_12mth_custom_z 	= (asp_gap3_12mth_custom - asp_gap3_12mth_custom_mu)/asp_gap3_12mth_custom_sd

gen 	asp_gap3_12mth_shop = (asp_gap3_12mth_space_z + asp_gap3_12mth_employ_z + asp_gap3_12mth_custom_z)/3
...
replace asp_12mth_lpred_space =. if asp_gap3_ideal_space_pos==0

gen 	asp_12mth_lpred_employ = ((asp_ideal_employ - labour_total)/asp_ideal_yrs) + labour_total
replace asp_12mth_lpred_employ =. if asp_gap3_ideal_employ_pos==0

gen 	asp_12mth_lpred_custom = ((asp_ideal_custom - custom_total)/asp_ideal_yrs) + custom_total
replace asp_12mth_lpred_custom =. if asp_gap3_ideal_custom_pos==0
...
*** Aspirations gap
gen 	asp_gap3_12mth_sales = (asp_12mth_sales - sales_nday)/asp_12mth_sales

gen 	asp_gap3_12mth_sales_neg = 1 if asp_gap3_12mth_sales<0
replace asp_gap3_12mth_sales_neg = 0 if asp_gap3_12mth_sales_neg ==.

gen 	asp_gap3_12mth_sales_0 = 1 if asp_gap3_12mth_sales==0
replace asp_gap3_12mth_sales_0 = 0 if asp_gap3_12mth_sales_0 ==.

gen 	asp_gap3_12mth_sales_pos = 1 if asp_gap3_12mth_sales>0
replace asp_gap3_12mth_sales_pos = 0 if asp_gap3_12mth_sales_pos ==.
...
* CSE
gen asp_cse_sales_scaled = asp_seff_sales_scaled*asp_loc_sales_scaled
...
gen 	asp_gap3_ideal_shop_yrs 		= asp_gap3_ideal_shop/asp_ideal_yrs
replace asp_gap3_ideal_shop_yrs		= asp_gap3_ideal_shop/asp_ideal_yrs_md if asp_ideal_yrs==.
...
gen 	asp_gap3_ideal_shop_seff 	= asp_gap3_ideal_shop_yrs * asp_seff_sales_scaled
gen 	asp_gap3_ideal_shop_cse 		= asp_gap3_ideal_shop_yrs * asp_seff_sales_scaled * asp_loc_sales_scaled
gen 	asp_gap3_ideal_shop_imp 		= asp_gap3_ideal_shop_yrs * asp_import_sales_scaled
gen 	asp_gap3_ideal_shop_prob 	= asp_gap3_ideal_shop_yrs * asp_prob_sales_scaled
gen 	asp_gap3_ideal_shop_cseimp 	= asp_gap3_ideal_shop_yrs * asp_seff_sales_scaled * asp_loc_sales_scaled * asp_import_sales_scaled
gen 	asp_gap3_ideal_shop_probimp 	= asp_gap3_ideal_shop_yrs * asp_prob_sales_scaled * asp_import_sales_scaled


*** 12 mth shop aspirations

gen 	asp_12mth_shop_cse 			= asp_12mth_shop * asp_seff_sales_scaled * asp_loc_sales_scaled
gen 	asp_12mth_shop_probimp 		= asp_12mth_shop * asp_prob_sales_scaled * asp_import_sales_scaled

gen 	asp_gap3_12mth_shop_seff 	= asp_gap3_12mth_shop 		* asp_seff_sales_scaled
gen 	asp_gap3_12mth_shop_cse 		= asp_gap3_12mth_shop 		* asp_seff_sales_scaled * asp_loc_sales_scaled
gen 	asp_gap3_12mth_shop_imp 		= asp_gap3_12mth_shop 		* asp_import_sales_scaled
gen 	asp_gap3_12mth_shop_cseimp	= asp_gap3_12mth_shop 		* asp_seff_sales_scaled * asp_loc_sales_scaled * asp_import_sales_scaled
gen 	asp_gap3_12mth_shop_probimp 	= asp_gap3_12mth_shop 		* asp_prob_sales_scaled * asp_import_sales_scaled
...
gen asp_gap3_12mth_space_cse 		= asp_gap3_12mth_space 		* asp_seff_sales_scaled * asp_loc_sales_scaled
gen asp_gap3_12mth_space_probimp		= asp_gap3_12mth_space 		* asp_prob_sales_scaled * asp_import_sales_scaled
...
gen asp_gap3_12mth_employ_cse 		= asp_gap3_12mth_employ 		* asp_seff_sales_scaled * asp_loc_sales_scaled
gen asp_gap3_12mth_employ_probimp	= asp_gap3_12mth_employ 		* asp_prob_sales_scaled * asp_import_sales_scaled
...
gen asp_gap3_12mth_custom_cse 		= asp_gap3_12mth_custom 		* asp_seff_sales_scaled * asp_loc_sales_scaled
gen asp_gap3_12mth_custom_probimp	= asp_gap3_12mth_custom 		* asp_prob_sales_scaled * asp_import_sales_scaled
...
gen 	asp_gap3_12mth_sales_cse 		= asp_gap3_12mth_sales 	* asp_seff_sales_scaled * asp_loc_sales_scaled
gen		asp_gap3_12mth_sales_probimp 	= asp_gap3_12mth_sales 	* asp_prob_sales_scaled * asp_import_sales_scaled



_crcslbl asp_12mth_sales 				f4_10_3c
_crcslbl asp_gap3_12mth_sales 			f4_10_3c
...
gen 		asp_gap3_min_prof = (prof_nday - asp_min_prof)/prof_nday

* IHS
gen 		asp_gap3_min_prof_ihs = ln(asp_gap3_min_prof + sqrt(asp_gap3_min_prof^2 +1))
...
* Aspiration gaps
gen 		asp_gap3_18mth_prof = (asp_18mth_prof - prof_nday)/asp_18mth_prof

gen 		asp_gap3_18mth_prof_neg = 1 if asp_gap3_18mth_prof<0
replace 	asp_gap3_18mth_prof_neg = 0 if asp_gap3_18mth_prof_neg ==.

gen 		asp_gap3_18mth_prof_0 = 1 if asp_gap3_18mth_prof==0
replace 	asp_gap3_18mth_prof_0 = 0 if asp_gap3_18mth_prof_0 ==.

gen 		asp_gap3_18mth_prof_pos = 1 if asp_gap3_18mth_prof>0
replace 	asp_gap3_18mth_prof_pos = 0 if asp_gap3_18mth_prof_pos ==.

gen 		asp_gap3_18mth_sales = asp_gap3_18mth_prof * (1+prof_nday_frac)



_crcslbl 	asp_min_prof 		f4_10_3b
_crcslbl 	asp_18mth_prof 		f4_10_3h
_crcslbl 	asp_gap3_min_prof 	f4_10_3b



***** ASPIRATIONS FOR OFFSPRING ************************************************

* Detect missing values in aspiration vars --> 343, 794, 1051, 732, 732, 1162, 329, 329, 329, 728, 728, 1156
...
*** Recoding "other" variables in occupancy aspirations


* Son's occupation "other" codings
...
* Daughter's occupation "other" codings
...
replace asp_occup_daughter_entrep = 0 if asp_occup_daughter_employ==.

* 728 zeros, though zero was not an answer
...
gen asp_occup_daughter_high = 1 if asp_occup_daughter>asp_occup_daughter_md & asp_occup_daughter!=.
replace asp_occup_daughter_high = 0 if asp_occup_daughter<=asp_occup_daughter_md
...
gen	satisfac_life		= f4_13a_01
mdesc satisfac_life
replace satisfac_life=. if f4_13a_01>10

gen	satisfac_fin		= f4_13a_02
mdesc satisfac_fin
replace satisfac_fin=. if f4_13a_02>10
...
label var W3_discuss_sellingprice 				"Dummy discuss bis sell price"
label var W3_discuss_sellingprice_wk 			"Dummy discuss bis sell price wkly"
...
label var W3_discuss_financing 					"Dummy discuss bis finance"
label var W3_discuss_buyingprice 				"Dummy discuss bis purch price"
...
label var W3_jointdec_sellingprice 				"Dummy joint dec sell price"
label var W3_jointdec_sellingprice_wk 			"Dummy joint dec sell price wkly"
...
label var W3_asp_min_prof 					"Minimum profits to get by with at EL"
label var W3_asp_gap3_min_prof 				"Asp gap: Min profits"
label var W3_asp_gap3_min_prof_ihs 			"Asp gap: Min profits (IHS)"
label var W3_asp_18mth_prof 					"Asp: 18 months profits"
...
label var W3_asp_occup_daughter_oth 			"Asp: daughter's occup other"
label var W3_asp_occup_daughter_employ 			"Asp: daughter's occup employee"
label var W3_asp_occup_daughter_entrep 			"Asp: daughter's occup entrepreneur"
label var W3_asp_occup_daughter 				"Asp: daughter's occup"
...
label var W3_asp_occup_son_high 				"Asp: dummy son's occup (high asp)"
label var W3_asp_occup_son_govt 				"Asp: dummy son's occup gov't"
label var W3_daughter1_age 						"Daughter age (1)"
label var W3_daughter2_age 						"Daughter age (2)"
label var W3_daughter3_age 						"Daughter age (3)"
label var W3_oldestdaughter_age 				"Oldest daughter's age"
label var W3_asp_educ_daughter 					"W3_asp_educ_daughter"
label var W3_asp_educ_daughter_ma 				"Asp: dummy daughter's educ master's"
label var W3_asp_occup_daughter_high 			"Asp: dummy daughter's occup (high asp)"
label var W3_asp_occup_daughter_govt 			"Asp: dummy daughter's occup gov't"
...
label var W3_asp_educ_kids_high 				"Asp: kids' educ (abvmc)"
label var W3_asp_occup_kids_high 				"Asp: kids' occup (abvmd) "
