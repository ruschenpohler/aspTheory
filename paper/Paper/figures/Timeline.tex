...
\resizebox{12cm}{20cm}{%
	...
	% endline
		...
		\\ [1.5ex]			
			\begin{tabular}{lll}
				\multicolumn{3}{p{1\textwidth}}{\footnotesize \textit{Notes}: This timeline provides details on the sequence of field activities carried out as part of this study. Preparatory activities (qualitative interviews, role model pre-selection), the listing of businesses, the interventions, as well as the baseline, the first and second endline surveys are distinguished by different coloring.}
			\end{tabular}
